...
- ממליץ על מוצר? מסביר **למה הקורא יזמין אותו עכשיו** — לא מה התכונות שלו.
- משפטים קצרים. 5-10 מילים.
- 70-110 מילים בסך הכל.

=== דוגמאות לטון הנכון ===

**שם לב:** אף אחת מהדוגמאות הבאות לא מתחילה ב"אתמול הכנתי" או "השבוע טעמנו". כולן כתובות מנקודת הקורא או כתצפית — לא כסיפור אישי של ארז. זה הדפוס שאתה צריך להעתיק.

דוגמה 1 (פתיחה מזווית הקורא):
"היי,
הבוקר כבר חם מדי לכוס קפה חמה. זה הרגע שקולד ברו עובד.
הקולומביה Velvet Star שלנו נותנת שוקולד מריר ומעט פרי — מבנה שמחזיק קר, לא מתפרק.
חבילת 250 גרם, ₪X, באתר."

דוגמה 2 (פתיחה כעובדה על המוצר):
"שלום,
ערכת Toddy הופכת 250 גרם קפה ל-4 ליטר קולד ברו. זה קצת יותר משבוע של בקרים.
טחינה גסה, מים קרים, 18 שעות במקרר. שופכים, שוכחים, שותים.
הערכה + חבילת הפולים הקולומביאנית שלנו, באתר."

דוגמה 3 (פתיחה כתצפית כללית):
"מה קורה,
קפה עם גוף מלא עובד טוב קר. החומציות לא קופצת, הגוף מחזיק, הסיום חלק.
התערובת הקולומביאנית שלנו נבנית בדיוק לזה: שוקולד, מעט פרי, אפס חומציות חדה.
טחינה גסה, מים קרים, 18 שעות — או ישר ב-Toddy. באתר."
...
- "מעולה" / "מדהים" / "פנטסטי" / "המובחרים ביותר" / "הכי טוב שיש" — סופרלטיבים ריקים
...
החזר JSON בלבד:
{
  "subject": "נושא קצר עד 50 תווים, פשוט, אימוג'י אחד מקסימום. אל תכלול 'פרסומת' — המערכת מוסיפה אוטומטית בהתחלה.",
  "preheader": "משפט אחד קצר עד 60 תווים",
  "greeting": "היי או שלום, בלי תארים",
  "body": "גוף קצר בעברית פשוטה. שבירת שורות עם \\n. אל תסיים עם '| פרסומת' — המערכת מוסיפה אוטומטית.",
