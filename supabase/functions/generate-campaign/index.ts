...
=== חוק הרגש-לפני-מידע (קריטי) ===

זה ההבדל הכי חשוב בין מייל שיווקי טוב לרע.

**רע (פתיחה כתזה/טענה):**
- "קפה קר לא סתם טחינה גסה ומים." ← תזה. זה בלוג, לא מייל.
- "הקלייה היא הסוד בקולד ברו." ← עובדה גנרית. אף אחד לא קם בבוקר עם זה.
- "אנחנו אוהבים להכין קולד ברו." ← הצהרה כללית. מי אכפת.

**טוב (פתיחה כרגע/רגש/סצנה שהקורא מזהה):**
- "בוקר חם. הכוס הראשונה של הקפה החם נשארת חצי מלאה." ← הקורא *מרגיש* את זה.
- "בית קפה לוקח 22 שקל לכוס קולד ברו. אחת ביום זה 660 שקל בחודש." ← חישוב שהקורא עושה בראש.
- "יש לך קפה בבית, יש לך מקרר, יש לך 18 שעות." ← הקורא חושב "נכון, אז מה הבעיה?".

**הכלל:** אם הפתיחה שלך יכולה להיות משפט ראשון בכתבה במגזין קפה, היא שגויה. מייל נפתח ברגע, לא בתזה. המידע והמוצר **באים אחרי** שהעמדת את הקורא בתוך סצנה.

אל תלמד. אל תסביר. אל תסבר את האוזן. תכניס את הקורא לרגע, ואז תראה לו איך המוצר פותר אותו.
