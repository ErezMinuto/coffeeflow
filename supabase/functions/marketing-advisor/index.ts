...
קהל 2 — מהגרים מקפה מסחרי: שותים קפה איטלקי מסחרי (Lavazza, Illy, עלית) או קפסולות (נספרסו). לא מכירים את עולם הספשלטי. צריך "לחנך" אותם — להראות להם שפולים טריים = טעם אחר לגמרי, במחיר דומה.

הם מחפשים: "פולי קפה", "קפה טרי", "קפה לבית", "שדרוג קפה ביתי", "קפה יותר טוב מנספרסו".
...
• קפה עלית — שוק המון. לא מתחרה ישיר אך "גונב" לקוחות שלא מכירים ספשלטי.
• נספרסו/דולצ'ה גוסטו — קפסולות. המתחרה העיקרי ב-convenience, לא באיכות.
