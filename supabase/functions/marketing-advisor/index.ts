  ...
  "campaigns_to_create": [
    {
      ...
      "rationale": "הסבר קצר",
      "creation_steps": [
        "שלב 1: כנס ל-ads.google.com → לחץ '+ קמפיין חדש'",
        "שלב 2: בחר מטרה (מכירות / לידים) → סוג קמפיין Search",
        "שלב 3: הגדר תקציב יומי ₪XX, בחר מיקוד גיאוגרפי ישראל",
        "שלב 4: הוסף קבוצת מודעות, הכנס מילות מפתח Exact/Phrase",
        "שלב 5: צור מודעה RSA — הדבק כותרות ותיאורים מהרשימה למעלה",
        "שלב 6: הוסף Negative Keywords מהרשימה: נספרסו, קפסולות, נמס, זול, מכונה",
        "שלב 7: הגדר אסטרטגיית בידינג — Target ROAS 400% או Maximize Conversions",
        "שלב 8: בדוק תצוגה מקדימה → פרסם"
      ]
    }
  ],
