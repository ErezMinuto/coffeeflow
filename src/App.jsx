              ...
              {filteredOrigins.map(origin => {
                ...
                if (isEditing) {
                          ...
                          <tr key={origin.id} style={{ background: '#FFF9F0', borderTop: '2px solid #FF6B35', borderBottom: '2px solid #FF6B35' }}>
                            ...
                            <td><input type="number" step="0.1" value={parseFloat(editingOrigin.stock || 0).toFixed(2)} onChange={(e) => setEditingOrigin({...editingOrigin, stock: e.target.value})} style={{ width: '80px', minWidth: '80px' }} /></td>
                            <td><input type="number" step="0.1" value={parseFloat(editingOrigin.roastedStock || 0).toFixed(2)} onChange={(e) => setEditingOrigin({...editingOrigin, roastedStock: e.target.value})} style={{ width: '80px', minWidth: '80px' }} /></td>
                            <td><input type="number" step="0.1" value={parseFloat(editingOrigin.dailyAverage || 0).toFixed(2)} onChange={(e) => setEditingOrigin({...editingOrigin, dailyAverage: e.target.value})} style={{ width: '80px', minWidth: '80px' }} /></td>                            <td>
